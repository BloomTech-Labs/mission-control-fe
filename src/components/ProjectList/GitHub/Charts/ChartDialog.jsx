...
import {
  chartContainer,
  chartTitle,
  sparklineModalContainer,
  rightModalArrow,
  leftModalArrow,
  modalChart,
  modalHeader,
  closeButton,
} from './chartDialog.module.scss';
    ...
    return (
      ...
      >
        <DialogTitle className={title} id="sparkline-chart-title">
          <div className={modalHeader}>
            ...
            <span
              ...
              onClick={() => props.toggleDialog('sparkChart')}
            >
              X
            </span>
          </div>
        ...
        <div className={sparklineModalContainer}>
          <ArrowBack
            className={leftModalArrow}
            onClick={() => {
              props.setCurrentIndex(changeIndex('decrement'));
            }}
          />
          ...
          <ArrowForward
            className={rightModalArrow}
            onClick={() => {
              props.setCurrentIndex(changeIndex('increment'));
            }}
          />
        </div>
      </Dialog>
