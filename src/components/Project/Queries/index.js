...
export const UPDATE_NOTE = gql`
	mutation UpdateNoteMutation($id: ID!, $topic: String!, $content: String!, $attendedBy: [String!]!, $rating: Int!) {
		updateNote(topic: $topic, content: $content, attendedBy: $attendedBy, id: $id, rating: $rating) {
			content
			topic
			attendedBy {
				name
