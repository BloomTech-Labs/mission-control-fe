...
const getMessage = grade => {
  switch (grade) {
    ...
    case 'B':
      return (
        <>Projects with Technical Debt Ratios between 5% and 10% are rated B</>
      );
    case 'C':
      return (
        <>Projects with Technical Debt Ratios between 10% and 20% are rated C</>
      );
    case 'D':
      return (
        <>Projects with Technical Debt Ratios between 20% and 50% are rated D</>
      );
    case 'F':
