...
export const GET_PROJECT_GROUP_MEMBERS_START =
  "GET_PROJECT_GROUP_MEMBERS_START";
export const GET_PROJECT_GROUP_MEMBERS_SUCCESS =
  "GET_PROJECT_GROUP_MEMBERS_SUCCESS";
export const GET_PROJECT_GROUP_MEMBERS_ERROR =
  "GET_PROJECT_GROUP_MEMBERS_ERROR";

export const GET_PROJECT_GROUP_MEMBER_START = "GET_PROJECT_GROUP_MEMBER_START";
export const GET_PROJECT_GROUP_MEMBER_SUCCESS =
...
export const GET_PROJECT_ROLE_BY_EMAIL_START =
  "GET_PROJECT_ROLE_BY_EMAIL_START";
export const GET_PROJECT_ROLE_BY_EMAIL_SUCCESS =
  "GET_PROJECT_ROLE_BY_EMAIL_SUCCESS";
export const GET_PROJECT_ROLE_BY_EMAIL_ERROR =
...
export const getProjects = () => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({ type: GET_PROJECTS_ERROR, payload: err.response })
      );
  };
};
...
export const getProject = id => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({ type: GET_PROJECT_ERROR, payload: err.response })
      );
  };
};
...
export const getProjectGroups = () => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({ type: GET_PROJECT_GROUPS_ERROR, payload: err.response })
      );
  };
};
...
export const getProjectGroupMembers = () => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({
          type: GET_PROJECT_GROUP_MEMBERS_ERROR,
...
export const getProjectRoles = () => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({ type: GET_PROJECT_ROLES_ERROR, payload: err.response })
      );
  };
};
...
export const getProjectRole = id => {
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .catch(err =>
        dispatch({ type: GET_PROJECT_ROLE_ERROR, payload: err.response })
      );
  };
};
  ...
  return dispatch => {
    ...
    axiosLabsGraphQL
      ...
      .then(res => {
        const projectRoles = res.data.data.projectRoles;
        dispatch({
          type: GET_PROJECT_ROLE_BY_EMAIL_SUCCESS,
